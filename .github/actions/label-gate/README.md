...
| `teams`        |    no    | `qvac-mgmt`, `qvac-mgmt`, `qvac-mgmt`, `qvac-mgmt`                       | Comma- and/or newline-separated team slugs (within the repository owner's org). Empty allowed if `users` is non-empty.                       |
