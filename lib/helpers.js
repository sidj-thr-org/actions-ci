...
/**
 * Validate a GitHub team slug.
 * CodeQL taint-flow guard: ensures the string matches GitHub's allowed format
 * (letters, digits, hyphens) before it is used in API calls.
 *
 * @param {string|undefined} raw
 * @param {string} flagName - flag name used in error messages (e.g. '--maintainers-team')
 * @returns {string}
 * @throws {Error} if the value is missing or contains invalid characters
 */
